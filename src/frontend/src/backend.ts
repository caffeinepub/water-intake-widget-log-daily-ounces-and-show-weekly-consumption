...
export class Backend implements backendInterface {
    ...
    async confirmPurchase(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getWeeklySummary(): Promise<Array<bigint> | null> {
        if (this.processError) {
            try {
    ...
    async recordIntake(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordIntake(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
